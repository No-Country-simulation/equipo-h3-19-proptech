...
export default function Sidebar() {
  ...
  return (
    <main className="h-[calc(100dvh-56px)] flex flex-col items-center justify-start bg-colorSecondary text-colorPrimary p-5 rounded-t-2xl overflow-auto scroll-hidden">
      {/*  
      //#region  PROGRESS 
      */}
